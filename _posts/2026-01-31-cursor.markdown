...
- 有_**Rules**_:
  ...
  - Rule应用的控制：
    ...
    <img src="/photos/image-20260201194107798.png" alt="image-20260201194107798" style="zoom:50%;" />
...
- _**Debug**_:
  ...
  - Capabilities: hypothesis generation, log instrumentation, runtime analysis 
    ...
    <img src="/photos/image-20260201053025836.png" alt="image-20260201053025836" style="zoom:50%;" />

  - Tools: 启用所有工具 + _**debug server**_

    <img src="/photos/image-20260201054118419.png" alt="image-20260201054118419" style="zoom:50%;" />
...
- **假报错**，需要通过终端创建一个_**buildServer.json**_文件:
  ...
  <img src="/photos/image-20260201193734925.png" alt="image-20260201193734925" style="zoom:50%;" />
